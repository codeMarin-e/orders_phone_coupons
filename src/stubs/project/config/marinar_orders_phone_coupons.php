...
return [
     ...
     */
    'install_behavior' => env('MARINAR_ORDERS_PHONE_COUPONS_INSTALL_BEHAVIOR', env('MARINAR_INSTALL_BEHAVIOR', true)),
     ...
     * 2 - keep everything
     */
    'delete_behavior' => env('MARINAR_ORDERS_PHONE_COUPONS_DELETE_BEHAVIOR', env('MARINAR_DELETE_BEHAVIOR', false)),
